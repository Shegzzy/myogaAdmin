        ...
        <div class="m-2 py-8 px-8 max-w-sm bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
            ...
            <div class="text-center space-y-2 sm:text-left">
                <div class="space-y-0.5">
                    ...
                    <p class="text-slate-500 font-medium">
                        Minimum Price: {props.minimumPrice}
                    </p>
                    <p class="text-slate-500 font-medium">
                        Start Price: {props.startPrice}
                    </p>
                </div>
                <EditMode id={props.id} name={props.name} rate={props.rate} duration={props.duration} minimumPrice={props.minimumPrice} startPrice={props.startPrice} />
