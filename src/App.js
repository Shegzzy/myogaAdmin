          ...
          <Route path="/">
            ...
            {userRole && (
              <>
                ...
                {/* super admin */}
                {(userRole.role === "Super Admin1" ||
                  userRole.role === "Super Admin2") && (
                  <>
                    <Route path="users">
                      <Route
                        index
                ...
                {/* finance admin */}
                {(userRole.role === "Finance1" ||
                  userRole.role === "Finance2") && (
                  <>
                    <Route path="company">
                      <Route
                        index
            ...
            <Route path="unverified-drivers">
              ...
              />
                ...
                {/* support admin */}
                {(userRole.role === "Support1" ||
                  userRole.role === "Support2") && (
                  <>
                    <Route path="bookings">
                      <Route
                        index
              ...
              />
                ...
                {/* Bus dev admin*/}
                {(userRole.role === "Business Dev1" ||
                  userRole.role === "Business Dev2") && (
                  <>
                    <Route path="company">
                      <Route
                        index
